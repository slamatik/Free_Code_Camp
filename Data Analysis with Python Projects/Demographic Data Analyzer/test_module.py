...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_higher_education_rich(self):
        ...
        self.assertAlmostEqual(actual, expected,
                               "Expected different value for percentage with higher education that earn >50K.")
    ...
    def test_rich_percentage(self):
        ...
        expected = 10
        self.assertAlmostEqual(actual, expected,
                               "Expected different value for percentage of rich among those who work fewest hours.")
